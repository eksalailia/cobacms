...
class KegiatanOPDController extends Controller
{
    public function index(Request $request){
        ...
        return view('opd.kegiatan.index', compact('aktivitas'));

    }
    public function create(){
        $aktivitas=Aktivitas::all();
        return view('opd.kegiatan.create', compact('aktivitas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $Aktivitas->save();
        if ($Aktivitas) {
            return redirect()->route('opd.kegiatan.index');
        } else {
            return redirect()->route('opd.kegiatan.index');
        }
    }
    ...
    public function edit($id) {
        ...
        return view('opd.kegiatan.edit',compact('data','aktivitas'));
    }
    ...
    {
        $aktivitas= Aktivitas::find($id);
        return view('opd.kegiatan.show', compact('aktivitas'));
    }
