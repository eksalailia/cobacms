        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    @endif
                                ...
                                <form method="POST" action="{{ route ('layouts.admin.petugas.create') }}" enctype=multipart/form-data >
                                @csrf
                                ...
                                <textarea class="ckeditor form-control valid" name="pelatihan" rows="5" cols="33" style="width:100%"></textarea>
                            </div>
