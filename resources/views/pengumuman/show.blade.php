                    ...
                    <div class="card" style="width: 50rem; margin-left: 150px">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item" style="font-size: 16px;"><b>Nama Pengumuman : </b>{{$data->nama_pengumuman}}</li>
                                <li class="list-group-item" style="font-size: 16px;"><b>Tanggal Pengumuman : </b>{{$data->tgl_pengumuman}}</li>
